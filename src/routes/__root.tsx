  ...
  head: () => ({
    meta: [
      ...
      { title: "Billy — a cozy companion for your thoughts" },
      {
        name: "description",
        content:
          "Billy keeps your thoughts and tasks in one quiet place and notices, gently, what you've been avoiding.",
      },
      { property: "og:title", content: "Billy — a cozy companion for your thoughts" },
      {
        property: "og:description",
        content: "Capture thoughts, keep track of tasks, and be gently reminded with care.",
      },
